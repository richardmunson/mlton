 ...
 */
PRIVATE void infRoundDRLimbs(int n_limbs, int d_limbs, int *r1_limbs, int *r2_limbs);
PRIVATE void zeroRoundDRLimbs(int n_limbs, int d_limbs, int *r1_limbs, int *r2_limbs);
